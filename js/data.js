...
export const synergyDefs = [
  ...
  {
    key: "shield_wall",
    classReq: "dark_knight",
    name: "Стена Щитов",
    needsVisuals: ["plate", "iron_helm", "iron_boots"],
    conditionStr: "[Латы] + [Шлем] + [Сапоги]",
    bonus: { health: 30, armor: 5 },
  },
  {
    key: "iron_will",
    classReq: "dark_knight",
    name: "Железная Воля",
    needsVisuals: ["sword", "plate"],
    conditionStr: "[Меч] + [Латы]",
    bonus: { damage: 5, armor: 3 },
  },
  {
    key: "juggernaut",
    classReq: "dark_knight",
    name: "Джаггернаут",
    needsVisuals: ["axe", "iron_helm", "iron_boots"],
    conditionStr: "[Топор] + [Шлем] + [Сапоги]",
    bonus: { lifeSteal: 0.05, damage: 8 },
  },
  {
    key: "spiked_armor",
    classReq: "dark_knight",
    name: "Шипастая Броня",
    needsVisuals: ["plate", "band"],
    conditionStr: "[Латы] + [Кольцо]",
    bonus: { bleed: 0.05, damage: 4 },
  },
  {
    key: "last_stand",
    classReq: "dark_knight",
    name: "Последний Рубеж",
    needsVisuals: ["sword", "pendant"],
    conditionStr: "[Меч] + [Ожерелье]",
    bonus: { crit: 0.1, combo: 0.1 },
  },
  ...
  // --- HUNTER SYNERGIES ---
  {
    ...
    classReq: "hunter",
    name: "Хищник",
    needsVisuals: ["dagger", "band"],
    conditionStr: "[Кинжал] + [Кольцо]",
    bonus: { combo: 0.05, evasion: 0.05 },
  },
  {
    key: "blood_scent",
    classReq: "hunter",
    name: "Запах Крови",
    needsVisuals: ["axe", "pendant"],
    conditionStr: "[Топор] + [Ожерелье]",
    bonus: { lifeSteal: 0.05, damage: 3 },
  },
  {
    key: "shadow_step",
    classReq: "hunter",
    name: "Шаг в Тень",
    needs: { evasion: 0.15, accuracy: 0.95 },
    bonus: { crit: 0.1, armor: 2 },
  },
  {
    key: "lethal_precision",
    classReq: "hunter",
    name: "Смертельная Точность",
    needs: { crit: 0.3, combo: 0.2 },
    bonus: { damage: 8, accuracy: 0.1 },
  },
  {
    key: "wolf_pack",
    classReq: "hunter",
    name: "Волчья Стая",
    needs: { bleed: 0.3, lifeSteal: 0.1 },
    bonus: { combo: 0.1, crit: 0.1 },
  },
  ...
  // --- CULTIST SYNERGIES ---
  {
    key: "occult_ritual",
    classReq: "cultist",
    name: "Оккультный Ритуал",
    needs: { combo: 0.3 },
    bonus: { lifeSteal: 0.05, damage: 4 },
  },
  {
    key: "void_gaze",
    classReq: "cultist",
    name: "Взгляд Пустоты",
    needs: { accuracy: 0.9, evasion: 0.08 },
    bonus: { crit: 0.08, combo: 0.08 },
  },
  {
    key: "soul_reaper",
    classReq: "cultist",
    name: "Жнец Душ",
    needs: { lifeSteal: 0.1, combo: 0.4 },
    bonus: { damage: 10, health: 50 },
  },
  {
    key: "blood_magic",
    classReq: "cultist",
    name: "Магия Крови",
    needs: { bleed: 0.15, health: 120 },
    bonus: { combo: 0.1, lifeSteal: 0.08 },
  },
  {
    key: "eldritch_frenzy",
    classReq: "cultist",
    name: "Жуткое Безумие",
    needs: { combo: 0.5 },
    bonus: { crit: 0.15, evasion: 0.1, damage: 5 },
  },
];
